...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_opgroup' => [
            'driver' => 'mysql',
            'host' => env('OPGROUP_HOST', '127.0.0.1'),
            'port' => env('OPGROUP_PORT', '3306'),
            'database' => env('OPGROUP_DATABASE', 'forge'),
            'username' => env('OPGROUP_USERNAME', 'forge'),
            'password' => env('OPGROUP_PASSWORD', ''),
            'unix_socket' => env('OPGROUP_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => FALSE,
        ...
        'mysql_pay' => [
            ...
            'port' => env('PAY_PORT', '3306'),
            'database' => env('PAY_DATABASE', 'forge'),
            'username' => env('PAY_USERNAME', 'forge'),
            'password' => env('PAY_PASSWORD', ''),
            'unix_socket' => env('PAY_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => FALSE,
